...
lbl_titulo = tk.Label(
    ventana, text="Contactos",  # Texto del título.
    font=("Arial", 24, "bold"), fg="white", bg="#1c1f33"  # Fuente, color del texto y fondo.
)
lbl_titulo.grid(row=0, column=0, columnspan=3, pady=10)  # Coloca el título en la parte superior, centrado.
