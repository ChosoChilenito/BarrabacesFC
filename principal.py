...
def abrir_contactos():
    messagebox.showinfo("Contactos", "Redirigiendo a Contactos")  # Muestra un cuadro de información.
    ventana.quit()  # Detiene el bucle principal de la ventana actual.
    ventana.destroy()  # Cierra la ventana actual.
    os.system("python Vistas/contactos.py")  # Ejecuta el script correspondiente a "Contactos".

# Función para abrir la sección "Ranking"
def abrir_ranking():
    messagebox.showinfo("Ranking", "Redirigiendo a Ranking")  # Muestra un cuadro de información.
    ventana.quit()  # Detiene el bucle principal de la ventana actual.
    ventana.destroy()  # Cierra la ventana actual.
    os.system("python Vistas/ranking.py")  # Ejecuta el script correspondiente a "Ranking".

# Función para abrir la sección "Entrenamiento"
def abrir_entrenamiento():
    messagebox.showinfo("Entrenamiento", "Redirigiendo a Entrenamiento")  # Muestra un cuadro de información.
    ventana.quit()  # Detiene el bucle principal de la ventana actual.
    ventana.destroy()  # Cierra la ventana actual.
    os.system("python Vistas/entrenamiento.py")  # Ejecuta el script correspondiente a "Entrenamiento".
